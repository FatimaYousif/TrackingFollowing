...
// //             "Executor activated — waiting for estimator initialization...");

// //         _state = State::Initializing;

// //         // wait before starting mode
// //         _init_timer = _node.create_wall_timer(
// //             2s,
// //             [this]()
// //             {
// //                 RCLCPP_INFO(_node.get_logger(),
// //                     "Initialization complete — starting yaw mode");
...
// //                                 "Failed to start yaw mode");
// //                         }
// //                     });

// //                 _init_timer.reset(); // stop timer
// //             });
// //     }
...
// //     {
// //         RCLCPP_INFO(_node.get_logger(),
// //             "Yawing mode executor deactivated");
// //     }
...
public:
        ...
        , _altitude_locked(false)
    {
        ...
        RCLCPP_INFO(_node.get_logger(), "px4 TOPICS !!!"); 
        ...
        RCLCPP_INFO(_node.get_logger(), "node initt !!!"); 
    }
  ...
  void loadParameters()
    {
        ...
        _search_velocity_z = _node.get_parameter("setpoint.search.velocity_z").as_double();
        _search_yaw_rate = _node.get_parameter("setpoint.search.yaw_rate").as_double();
         RCLCPP_WARN(_node.get_logger(), "Params loaded!");
...
public:
    ...
    
    {
        ...
        RCLCPP_INFO(_node.get_logger(), "Timer before !!!"); 
        _timer = _node.create_wall_timer(
            1000ms,
            std::bind(&FollowTargetExecutor::checkMode, this));
        RCLCPP_INFO(_node.get_logger(), "Timer after !!!"); 
    }
    ...
    void onActivate() override
    {
        ...
        // runState(State::TakingOff, px4_ros2::Result::Success);
        _state = State::Yawing;
         RCLCPP_INFO(_node.get_logger(), "going to run state ---- !!!"); 
        runState(State::Yawing, px4_ros2::Result::Success);
         RCLCPP_INFO(_node.get_logger(), "entering run state ---- !!!"); 
